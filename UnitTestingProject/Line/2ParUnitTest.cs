...
namespace UnitTestingProject.Line
{
    ...
    public class Test2Par
    {
        ...
        public void TestOm2Par()
        {
            ...
            _spil.SpillereCollection[1].PointFelter[8].Point = 0;
            _spil.SpillereCollection[1].PointFelter[8].CanChange = true;
        ...
        public void TestOm4EnsCanNotChange()
        {
            _spil = SpilSingelton.InstansSpil;
            _spil.SpillereCollection[1].PointFelter[8].Point = 0;
            _spil.SpillereCollection[1].PointFelter[8].CanChange = false;
